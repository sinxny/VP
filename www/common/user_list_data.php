...
$SQL = "SELECT U.UNO, U.USER_NAME, U.DUTY_NAME, D.DEPT_PATH_S 
        ...
        DECODE(U.JOBDUTY_CD, 'B1', 1), DECODE(U.JOBDUTY_CD, 'B2', 2), DECODE(U.JOBDUTY_NAME, '팀장', 3), DECODE(U.JOBDUTY_CD, 'D3', 4), DECODE(U.JOBDUTY_CD, 'M1', 5),
        U.JOBDUTY_CD, U.DUTY_CD, U.JOIN_DATE, U.USER_NAME";
